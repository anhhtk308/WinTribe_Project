    ...
    create() {
        ...
        this.socket.on('getPlayerShop', function(data) {
            ...
            if ((self.exportObj).speed === true) {
                ...
                self.speed.removeListener("pointerdown");
            }
